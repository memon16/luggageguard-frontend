      ...
      <body onload="window.print()">
        <div class="label">
          ...
          <div class="section">
            ...
            <p class="value" style="font-weight: normal;">${new Date(booking.pickupDate).toLocaleDateString('en-US', {timeZone: 'UTC'})} • ${booking.pickupTimeSlot}</p>
          </div>
          <div class="section">
            <p class="label-text">DELIVERY</p>
            <p class="value">${booking.deliveryAddress}</p>
            <p class="value" style="font-weight: normal;">${new Date(booking.deliveryDate).toLocaleDateString('en-US', {timeZone: 'UTC'})} • ${booking.deliveryTimeSlot}</p>
          </div>
          <div class="section">
